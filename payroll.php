    ...
    <div class="row flex">
        <div class="col bg-dark vh-100 sticky-top" style="width: 100px;">
            ...
            <ul style="font-size:130%;">
                ...
                <li class="list-group-item" style="margin-bottom: 2rem;"><a href="burger.php" class="text-white text-decoration-none">POS</a></li>
        ...
        <div class="col-8  flex-grow-1" style="background-image:url('background/that.jpg'); background-attachment: fixed;">

            <div class="container border" style="background-color:floralwhite;">
            
                <div class="container">
                    <div class="page_border" style="background-image:url('background/that.jpg'); background-attachment: fixed;"> 
                        <h1 class="text-center" style="padding-top:10px; padding-bottom:10px; font-weight:bold;">Ced's Choice Payroll Application</h1>
                        <h5 style="padding-top:10px; font-weight:bold;">EMPLOYEE BASIC INFO:</h5>
                        <form action="Payroll.php" method="POST">
                            <div class="payrol_form_group1">
                                <div style="float:left; width:50%;">
                                    <div style="margin-left:100px; margin-top:10px;">
                                        <img src="css/images/null.jpg" class="imgthumbnail" style="width:250px;" alt="Picture Preview">
