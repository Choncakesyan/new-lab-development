...
<body>
    <div class="row flex">
        <div class="col bg-dark vh-100 sticky-top" style="width: 100px;">
            <h2 style="margin-bottom: 2rem; text-align:center; font-family:Times New Roman; color:white;">Menu</h2>
            <ul style="font-size:130%;">
                <li class="list-group-item" style="margin-bottom: 2rem;"><a href="admin.php" class="text-white text-decoration-none">Home</a></li>
                ...
                <li class="list-group-item" style="margin-bottom: 2rem;"><a href="perfume.aphp" class="text-lightskyblue text-decoration-none">POS</a></li>
                <li class="list-group-item" style="margin-bottom: 2rem;"><a href="" class="text-white text-decoration-none">POS Sales Report</a></li>
                <li class="list-group-item" style="margin-bottom: 2rem;"><a href="user.php" class="text-white text-decoration-none">User Account</a></li>
                <li class="list-group-item" style="margin-bottom: 2rem;"><a href="login.php" class="text-white text-decoration-none">Logout</a></li>
            </ul>
        </div>
        <div class="col-8  flex-grow-1" style="background-image:url('images/that.jpg');background-attachment: fixed;">         
            <main class="container">
                <h1 class="text-center my-1" style="font-family:serif; font-size:70px;"><b>Kitchen Utensil Shop</b></h1>
                <div class="">
                    <!-- dropdown -->
                    <div class="px-3">
                        <div class="btn-group bg-white">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="perfume.php">Perfume Shop</a></li>
                                <li><a class="dropdown-item" href="burger.php">Brrger Shop</a></li>
                                <li><a class="dropdown-item" href="kitchen.php">Kitchen Utensil</a></li>
                                <li><a class="dropdown-item" href="mouse.php">Mouse Collection</a></li>
                        ...
                        for ($i = 1; $i < 21; $i++) {
                            ...
                            <div class='col'onclick='handleItems(\"$label\", \"$price\")' role='button'>
                                <div class='card mb-4 mx-3 ' style='width: 190px;'>
                                    <div class='row g-0'>
                                        <img src='kitchen_images/$i.jpg' class='card-img-top rounded-start' alt='...' height='190'/>
