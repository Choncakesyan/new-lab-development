...
<header style="text-align:center">
 <h1 style="font-style:bold; font-family:cursive; color:red">EMPLOYEE SALARY COMPUTATION DETAILS</h1>
 <?php 
 ...
 if($_SERVER['REQUEST_METHOD']=='POST'){
   ...
   $gross_income=(($rate_per_hour*$hours_per_day)*$days_per_week)*$weeks_per_month;
    ...
    <span style="margin-left:57px">Employee Number:</span> <input type="text"name="employee_number" value="<?php echo $employee_number;?>"/>
    <br/>
 ...
 <br>
 <br>
 <span style="margin-left:-50px" ><font size="5px" color="dark orange">SSS Contribution</font></span>
 <br>
 ...
 <br>
 <br>
 <span style="margin-left:-50px" ><font size="5px" color="dark orange">Pagibig Contribution</font></span>
 <br/>
 <span style="margin-left:80px" "padding-top:3px">Pagibig Contribution:</span>
 <input type="text" name="pagibig" value="<?php echo $pagibig;?>"/>
 <br>
 <br>
 <span style="margin-left:-85px"><font size="5px" color="dark orange">Philhealth Contribution</font></span><br>
