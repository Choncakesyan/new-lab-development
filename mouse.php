    ...
    <div class="row flex">
        ...
        <div class="col-8  flex-grow-1" style="background-image:url('images/that.jpg');background-attachment: fixed;">         
            <main class="container">
                <h1 class="text-center my-1" style="font-family:serif; font-size:70px;"><b>Mouse Collection</b></h1>
                <div class="">
                    <!-- dropdown -->
                    <div class="px-3">
                        ...
                        for ($i = 1; $i < 21; $i++) {
                            ...
                            <div class='col'onclick='handleItems(\"$label\", \"$price\")' role='button'>
                                <div class='card mb-4 mx-3 ' style='width: 190px;'>
                                    <div class='row g-0'>
                                        <img src='mouse_images/$i.jpg' class='card-img-top rounded-start' alt='...' height='190'/>
